...
const embeddedCallingService_1 = require("./calling/embeddedCallingService");
...
class App {
    constructor(extensionContext, liveShare) {
        ...
        const liveShareConfiguration = vscode.workspace.getConfiguration('liveshare');
        const featureSet = liveShareConfiguration.get('featureSet');
        this.callingService = (featureSet === 'insiders') ?
            new externalAppCallingService_1.ExternalAppCallingService(liveShare, true) :
            new embeddedCallingService_1.EmbeddedCallingService(liveShare, true);
