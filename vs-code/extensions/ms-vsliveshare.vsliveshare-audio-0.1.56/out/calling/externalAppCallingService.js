    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const slimcorePath = path.join(extensionutil_1.ExtensionUtil.Context.extensionPath, 'node_modules/slimcore-3.0/bin/slimcore.node');
                if (!fs.existsSync(slimcorePath)) {
                    throw new Error(`SlimCore not found: ${slimcorePath}`);
                }
                ...
                this.childProcess.on('close', () => __awaiter(this, void 0, void 0, function* () {
                    if (!this.isDisposed) {
                        // Electron ended unexpectedly
                        // Clean up and log an error
                        this.endCallEventEmitter.fire();
                        yield this.dispose();
                        this.trace.error('Electron closed unexpectedly');
                    }
                }));
