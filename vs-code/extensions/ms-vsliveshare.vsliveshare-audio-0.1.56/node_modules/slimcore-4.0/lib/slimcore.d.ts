...
declare module SlimCore {
    ...
    interface Engine extends Disposable, EventEmitter<Engine.Events> {
        ...
        // return a bit mask of all supported effects
        getVideoEffectsCapability(videoObjectId: ObjectId): number;
        setVideoEffects(type: Enums.VideoEffectType, videoObjectId: ObjectId): void;
        setDefaultStartingVideoEffects(type: Enums.VideoEffectType): void;
